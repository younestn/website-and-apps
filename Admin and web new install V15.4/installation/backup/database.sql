...
--
-- Host: localhost:8889
-- Generation Time: Aug 12, 2025 at 06:46 AM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2025-08-12 06:45:54', NULL),
...
(18, 'colors', '{\"primary\":\"#1b7fed\",\"secondary\":\"black\",\"primary_light\":\"#CFDFFB\"}', '2020-10-11 13:53:02', '2025-08-12 06:45:54'),
...
(49, 'social_login', '[{\"login_medium\":\"google\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1},{\"login_medium\":\"facebook\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1}]', NULL, '2025-08-12 06:45:54'),
...
(104, 'apple_login', '[{\"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1,\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}]', NULL, '2025-08-12 06:45:54'),
...
(1, 404, 'http://127.0.0.1:8000/admin/messages/new-notification', 15, NULL, NULL, '2024-12-21 06:49:44', '2025-07-16 09:12:29'),
...
(7, 'customer', 'order_failed_message', 'Order fa Message', 0, '2023-10-30 11:02:55', '2025-08-12 06:45:54'),
...
CREATE TABLE `order_details_rewards` (
  ...
  `reward_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'coupon, loyalty_point and others',
...
CREATE TABLE `shops` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `seller_id` bigint(20) NOT NULL,
  `author_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'vendor' COMMENT 'vendor, admin',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `vacation_duration_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tin_certificate_storage_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'public',
...
(0, 'Walk-In Customer', 'Walk-In', 'Customer', '000000000000', 'def.png', 'walking@customer.com', NULL, '', NULL, NULL, '2025-08-12 06:45:54', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, 'en');
