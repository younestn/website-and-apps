              ...
              Row(children: [
                Container(transform: isLtr ? Matrix4.translationValues(12, -20, 0) : Matrix4.translationValues(-12, -20, 0), height: 60, width: 60,
                    child: Stack(children: [
                      ...
                      vacationIsOn == true ?
                      Center(child: Text(getTranslated('close_for_now', context)!, textAlign: TextAlign.center, style: textRegular.copyWith(
                        color: Colors.white,
                        fontSize: Dimensions.fontSizeExtraSmall,
                      ))) : const SizedBox(),
                    ])),
                  ...
                  child: Row( children: [
                    ...
                    Expanded(child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text("${getTranslated('products', context)}", style: textBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color)
                          )])))])),
            ]),
          ),
        )
