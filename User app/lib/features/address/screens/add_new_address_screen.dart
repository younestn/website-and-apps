                              ...
                              child: SizedBox(height: 50,
                                child: Row(children: <Widget>[
                                  Row(children: [
                                      ...
                                      Text(getTranslated('shipping_address', context)??'', style: textRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color),),]),
                                  ...
                                  Row(children: [
                                    Radio<Address>(
                                      ...
                                      onChanged: (Address? value) {
                                        setState(() {
                                          _address = value;});}),
                                      Text(getTranslated('billing_address', context)??'', style: textRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color))])]))),
